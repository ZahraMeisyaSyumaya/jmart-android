...
import zahraJmartRK.jmart_android.request.RegisterRequest;
import zahraJmartRK.jmart_android.request.RegisterStoreRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTopUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String URL = "http://10.0.2.2:7080/account/"+LoginActivity.getLoggedAccount().id+"/topUp";
                StringRequest topUpRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(getApplicationContext(), "Top Up unsuccessful", Toast.LENGTH_LONG).show();
                        }
                    }
